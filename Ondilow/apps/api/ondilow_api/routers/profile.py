...
from ondilow_api.models import Activity, AthleteProfile, Equipment, PersonalRecord
from ondilow_api.schemas.activity import ActivityDetail
...
def export_data(current_user: CurrentUser, db: DbSession) -> Response:
    ...
    return Response(
        ...
        headers={"Content-Disposition": f'attachment; filename="ondilow_export_{current_user.id}.json"'},
    )
