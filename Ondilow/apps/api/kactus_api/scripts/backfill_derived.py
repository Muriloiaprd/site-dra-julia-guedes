...
Rodar (da pasta apps/api):
    uv run python -m kactus_api.scripts.backfill_derived --dry-run
    uv run python -m kactus_api.scripts.backfill_derived
...
from kactus_api.models import Activity, ActivityPoint, User
