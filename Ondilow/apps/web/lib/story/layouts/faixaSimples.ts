...
/**
 * Modelo "6" do usuário: só a faixa de 3 colunas e o disco da logo em cima
...
export const faixaSimples: StoryLayout = {
  ...
  draw(ctx, data) {
    ...
    const base = buildArtLayer(data.art, R.art, { mode: "clear", rects: R.band.colClears }, data.color, [R.logoDisc]);
